		...
		this.result = [
			{
				...
				icon: '<i class="flaticon-interface-3 b404-font-warning">',
				text: 'Annual finance report',
				type: 1
			}, {
				icon: '<i class="flaticon-share b404-font-success"></i>',
				text: 'Company meeting schedule',
				type: 1
			}, {
				icon: '<i class="flaticon-paper-plane b404-font-info"></i>',
				...
				icon: '<i class="flaticon-lifebuoy b404-font-warning"></i>',
				text: 'Revenue report',
				type: 1
			}, {
				icon: '<i class="flaticon-coins b404-font-primary"></i>',
				text: 'Anual finance report',
				type: 1
			}, {
				icon: '<i class="flaticon-calendar b404-font-danger"></i>',
