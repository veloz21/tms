...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.widget4_3 = shuffle([
      {
        icon: 'flaticon-pie-chart-1 b404-font-info',
        title: 'Metronic v6 has been arrived!',
        url: 'https://keenthemes.com.my/metronic',
        value: '+$500',
        valueColor: 'b404-font-info'
      }, {
        icon: 'flaticon-safe-shield-protection b404-font-success',
        title: 'Metronic community meet-up 2019 in Rome.',
        url: 'https://keenthemes.com.my/metronic',
        value: '+$1260',
        valueColor: 'b404-font-success'
      }, {
        icon: 'flaticon2-line-chart b404-font-danger',
        title: 'Metronic Angular 8 version will be landing soon..',
        url: 'https://keenthemes.com.my/metronic',
        value: '+$1080',
        valueColor: 'b404-font-danger'
      }, {
        icon: 'flaticon2-pie-chart-1 b404-font-primary',
        title: 'ale! Purchase Metronic at 70% off for limited time',
        url: 'https://keenthemes.com.my/metronic',
        value: '70% Off!',
        valueColor: 'b404-font-primary'
      }, {
        icon: 'flaticon2-rocket b404-font-brand',
        title: 'Metronic VueJS version is in progress. Stay tuned!',
        url: 'https://keenthemes.com.my/metronic',
        value: '+134',
        valueColor: 'b404-font-brand'
      }, {
        icon: 'flaticon2-notification b404-font-warning',
        title: 'Black Friday! Purchase Metronic at ever lowest 90% off for limited time',
        url: 'https://keenthemes.com.my/metronic',
        value: '70% Off!',
        valueColor: 'b404-font-warning'
      }, {
        icon: 'flaticon2-file b404-font-focus',
        title: 'Metronic React version is in progress.',
        url: 'https://keenthemes.com.my/metronic',
        value: '+13%',
        valueColor: 'b404-font-focus'
      },
    ]);
    // @ts-ignore
