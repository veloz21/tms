...
export class HtmlClassService {
	...
	private initLayout() {
		...
		document.body.classList.add('b404-quick-panel--right');
		document.body.classList.add('b404-demo-panel--right');
		document.body.classList.add('b404-offcanvas-panel--right');
	}
	...
	private initHeader() {
		...
		if (objectPath.get(this.config, 'header.self.fixed.desktop')) {
			document.body.classList.add('b404-header--fixed');
			objectPath.push(this.classes, 'header', 'b404-header--fixed');
		} else {
			document.body.classList.add('b404-header--static');
		}

		if (objectPath.get(this.config, 'header.self.fixed.mobile')) {
			document.body.classList.add('b404-header-mobile--fixed');
			objectPath.push(this.classes, 'header_mobile', 'b404-header-mobile--fixed');
		}

		if (objectPath.get(this.config, 'header.menu.self.layout')) {
			objectPath.push(this.classes, 'header_menu', 'b404-header-menu--layout-' + objectPath.get(this.config, 'header.menu.self.layout'));
		}
	}
	...
	private initSubheader() {
		...
		if (objectPath.get(this.config, 'subheader.fixed')) {
			document.body.classList.add('b404-subheader--fixed');
		}

		if (objectPath.get(this.config, 'subheader.display')) {
			document.body.classList.add('b404-subheader--enabled');
		}

		if (objectPath.has(this.config, 'subheader.style')) {
			document.body.classList.add('b404-subheader--' + objectPath.get(this.config, 'subheader.style'));
		}
	}
	...
	private initAside() {
		...
		document.body.classList.add('b404-aside--enabled');

		// Fixed Aside
		if (objectPath.get(this.config, 'aside.self.fixed')) {
			document.body.classList.add('b404-aside--fixed');
			objectPath.push(this.classes, 'aside', 'b404-aside--fixed');
		} else {
			document.body.classList.add('b404-aside--static');
		}

		// Default fixed
		if (objectPath.get(this.config, 'aside.self.minimize.default')) {
			document.body.classList.add('b404-aside--minimize');
		}

		// Menu
		// Dropdown Submenu
		if (objectPath.get(this.config, 'aside.menu.dropdown')) {
			objectPath.push(this.classes, 'aside_menu', 'b404-aside-menu--dropdown');
	...
	private initFooter() {
		...
		if (objectPath.get(this.config, 'footer.self.fixed')) {
			document.body.classList.add('b404-footer--fixed');
		}
	}
	...
	private initSkins() {
		if (objectPath.get(this.config, 'header.self.skin')) {
			document.body.classList.add('b404-header-base-' + objectPath.get(this.config, 'header.self.skin'));
		}
		if (objectPath.get(this.config, 'header.menu.desktop.submenu.skin')) {
			document.body.classList.add('b404-header-menu-' + objectPath.get(this.config, 'header.menu.desktop.submenu.skin'));
		}
		if (objectPath.get(this.config, 'brand.self.skin')) {
			document.body.classList.add('b404-brand-' + objectPath.get(this.config, 'brand.self.skin'));
		}
		if (objectPath.get(this.config, 'aside.self.skin')) {
			document.body.classList.add('b404-aside-' + objectPath.get(this.config, 'aside.self.skin'));
		}
	}
}
