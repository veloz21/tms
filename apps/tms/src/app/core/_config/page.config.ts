export class PageConfig {
	public defaults: any = {
		...
		ecommerce: {
			...
			employees: {
				edit: {
					page: {title: 'Edit employee', desc: ''}
				},
				add: {
					page: {title: 'Create employee', desc: ''}
				}
			},
			products: {
				edit: {
		...
		maintenance: {
			box: {
				edit: {
					page: {title: 'Edit Box', desc: ''}
				},
				add: {
					page: {title: 'Create Calax', desc: ''}
				}
			},
			tire: {
				edit: {
					page: {title: 'Edit tire', desc: ''}
				},
				add: {
					page: {title: 'Create tire', desc: ''}
				}
			},
		},
		workshop: {
			trucks: {
				page: {title: 'Trucks', desc: ''}
			},
			maintenance: {
				page: {title: 'Maintenance', desc: ''}
			}
		},
		'user-management': {
			users: {
