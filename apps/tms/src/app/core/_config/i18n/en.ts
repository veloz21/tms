      ...
      TRAVEL: {
        TEXT: {
          ...
          DELETE_ONE_DESCRIPTION:
            'Are you sure to permanently delete this travel?',
          ...
          DELETE_MANY_DESCRIPTION:
            'Are you sure to permanently delete selected travels?',
    ...
    WORKSHOP: {
      ...
      MAINTENANCE: {
        TEXT: {
          ...
          DELETE_ONE_DESCRIPTION:
            'Are you sure to permanently delete this maintenance?',
          ...
          DELETE_MANY_DESCRIPTION:
            'Are you sure to permanently delete selected maintenances?',
          ...
          ADD_MAINTENANCE_MESSAGE:
            'New maintenance successfully has been added.',
