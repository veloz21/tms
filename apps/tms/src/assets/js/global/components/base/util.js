...
var KTUtil = function() {
    ...
    return {
        ...
        actualCss: function(el, prop, cache) {
            ...
            if (!el.getAttribute('b404-hidden-' + prop) || cache === false) {
                var value;
                ...
                // store it in cache
                el.setAttribute('b404-hidden-' + prop, value);

                return parseFloat(value);
            } else {
                // store it in cache
                return parseFloat(el.getAttribute('b404-hidden-' + prop));
            }
        },
        ...
        scrollInit: function(element, options) {
            ...
            function init() {
                ...
                if (ps) {
                    ...
                    KTUtil.addClass(element, 'b404-scroll');
...
// CSS3 Transitions only after page load(.b404-page-loading class added to body tag and remove with JS on page load)
window.onload = function() {
    KTUtil.removeClass(KTUtil.get('body'), 'b404-page--loading');
}
